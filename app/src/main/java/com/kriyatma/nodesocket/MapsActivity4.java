...
/**
 * Created by malli on 5/24/2016.
 */
public class MapsActivity4 extends FragmentActivity implements
    ...
    public static final String TAG = MapsActivity4.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("pppppppppppppppppppppppppppppppppppppppppppppp","11111111111111111111111111111111111111111111111111111111111");
    ...
    private Emitter.Listener handleIncomingMessages = new Emitter.Listener(){
        ...
        public void call(final Object... args){
            Log.d("string1",String.valueOf(args.length));
            new FragmentActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
                   Log.d("string",String.valueOf(args.length));
                    JSONObject data = (JSONObject) args[0];
                    //JSONArray cast = jsonResponse.getJSONArray();
                    Log.d("data",String.valueOf(data));

                    Log.d("length", String.valueOf(args.length));
                    String coordinate1;
                    String coordinate2;
                    //String sender;
                    // String imageText;
    ...
    private void handleNewLocation(Location location) {
        ...
        try {
            ...
            requestObject.put("receiver",db.getUser());

        } catch (JSONException e) {
            e.printStackTrace();
        }
        Log.d("receiver", db.getUser());
        socket.emit("LatLng4", requestObject);
