...
public class SQLiteHandler extends SQLiteOpenHelper {
   ...
   // private static final String KEY_QTY = "qty";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_RECEIVER_TABLE = "CREATE TABLE " + TABLE_RECEIVER + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_RECEIVER + " TEXT"
                + ");";
...
/*
    ...
    public String getUser() {
        ...
        db.close();
        // return user
        Log.d(TAG, "Fetching user from Sqlite: " + order.get("name"));
