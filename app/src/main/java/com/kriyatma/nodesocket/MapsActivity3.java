 ...
 */
public class MapsActivity3 extends FragmentActivity implements
    ...
    private void handleNewLocation(Location location) {
        ...
        try {
            ...
            requestObject.put("sender",db.getUser());

        } catch (JSONException e) {
            e.printStackTrace();
        }
        socket.emit("LatLng3",requestObject);

        Log.d("coordinate",String.valueOf(latLng));
        Intent intent=new Intent(getApplicationContext(), SocketActivity2.class);
